    ...
    getStatistics = async() => {
        try {
            ...
            if (result.code === 200) {
                ...
                this.topContent[0].number = this.statistics.todayBuy || 0;
                this.topContent[1].number = this.statistics.todaySale || 0;
                this.topContent[2].number = this.statistics.monthBuy || 0;
                this.topContent[3].number = this.statistics.monthSale || 0;
            }
            if (result.code === 510) {
