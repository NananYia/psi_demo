...
import ModalFormButton from '../OtherOutModal';
import './index.less';
interface OtherInTableProps { 
    columns: any;
    dataSource: any;
    rowSelection: any;
...
@observer
export default class OtherInTable extends React.Component<OtherInTableProps, any>{
    @observable
    private columns:any;
    @observable
    dataSource: any=[];
    ...
    constructor(props) {
        ...
        this.columns = [
            ...props.columns,
            {
                title: '状态', dataIndex: 'status', width: 40, align: "center", scopedSlots: { customRender: 'customRenderFlag' },
                render: (status) => {
    ...
    render() {
        ...
        return (
            <div className="OtherInTable-container">
                <Table
